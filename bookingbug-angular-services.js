...
(function() {
  ...
  * @property {integer} order The person order
  ...
  angular.module('BB.Models').factory("Admin.PersonModel", function($q, AdminPersonService, BBModel, BaseModel, PersonModel) {
    var Admin_Person;
...
(function() {
  ...
  * @property {boolean} disabled Verify if resources is disabled or not
  ...
  angular.module('BB.Models').factory("Admin.ResourceModel", function($q, AdminResourceService, BBModel, BaseModel, ResourceModel) {
    var Admin_Resource;
...
(function() {
  ...
  * @property {date} duration The schedule duration
  ...
  angular.module('BB.Models').factory("Admin.ScheduleModel", function($q, AdminScheduleService, BBModel, BaseModel, ScheduleRules) {
    var Admin_Schedule;
...
(function() {
  ...
  * @property {integer} max_booings The maximum number of bookings
  ...
  angular.module('BB.Models').factory("Admin.ServiceModel", function($q, AdminServiceService, BBModel, ServiceModel) {
    var Admin_Service;
